...
CUDA_VISIBLE_DEVICES=0 OMP_NUM_THREADS=4 python -u pointer.py --mode parse --config configs/parsing/l2r.json --num_epochs 600 --batch_size 256 \
 ...
 --model_path "models/"$1 \
--bert --bert_dim 1024 \
--bert_path_test "/home/danifg/embs/ptb.test.bertlarge.cased"
